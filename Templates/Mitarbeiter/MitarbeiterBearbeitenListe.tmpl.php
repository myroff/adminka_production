...
<html>
	<head>
		<title>SWIFF: Mitarbeiter bearbeiten.</title>
		...
		<div id="mainContent">
			...
			<div id="resultsDiv">
				...
				else
				{
					...
					{
						echo "<tr>";
						echo "<td><a href='".BASIS_URL."/admin/mitarbeiterBearbeitenById/".$r['mtId']."' />Bearbeiten</a></td>";
						echo "<td>".$r['anrede']."</td>";
						...
						echo "<td>".$r['handy']."</td>";
						echo "<td>".$r['email']."</td>";
						echo "<td>".$r['eingestelltAm']."</td>";
						echo "<td>".$r['entlassenAm']."</td>";
						echo "</tr>";
					}
				}
				?>
